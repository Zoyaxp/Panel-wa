...
return {
conversation: 'WhatsApp Bot By Minsoo⚡'
}}
}
...
let teksnotif = `*SC CPANEL BY CACAALVV* Berhasil Tersambung Ke Nomor WhatsApp ${Skyzo.user.id.split(":")[0]}`
Skyzo.sendMessage("6285283090385@s.whatsapp.net", {text: teksnotif})
